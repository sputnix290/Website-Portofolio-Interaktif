...
- **Dark / Light Theme** – automatic OS detection with manual toggle
- **Glass‑Morphism Cards** – futuristic translucent panels with backdrop blur
...
![Tampilan web](Portofolio/frontend/public/tampilan.png)
